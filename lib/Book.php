...
class Book extends Base {
    ...
    {
        return BookServices::getDefault()->getEntryIdByLetter($startingLetter);
    }
    
    public static function getFilterString ()
    {
        return BookServices::getDefault()->getFilterString();
    }
    
    public static function getBookCount($database = NULL)
    {
        return BookServices::getDefault()->getBookCount($database);
    }

    public static function getCount()
    {
        return BookServices::getDefault()->getCount();
    }

    public static function getBooksByAuthor($authorId, $n)
    {
        return BookServices::getDefault()->getBooksByAuthor($authorId, $n);
    }

    public static function getBooksByRating($ratingId, $n)
    {
        return BookServices::getDefault()->getBooksByRating($ratingId, $n);
    }

    public static function getBooksByPublisher($publisherId, $n)
    {
        return BookServices::getDefault()->getBooksByPublisher($publisherId, $n);
    }

    public static function getBooksBySeries($serieId, $n)
    {
        return BookServices::getDefault()->getBooksBySeries($serieId, $n);
    }

    public static function getBooksByTag($tagId, $n)
    {
        return BookServices::getDefault()->getBooksByTag($tagId, $n);
    }

    public static function getBooksByLanguage($languageId, $n)
    {
        return BookServices::getDefault()->getBooksByLanguage($languageId, $n);
    }

    public static function getBooksByCustom($customColumn, $id, $n)
    {
        return BookServices::getDefault()->getBooksByCustom($customColumn, $id, $n);
    }

    public static function getBookById($bookId)
    {
        return BookServices::getDefault()->getBookById($bookId);
    }

    public static function getBookByDataId($dataId)
    {
        return BookServices::getDefault()->getBookByDataId($dataId);
    }

    public static function getBooksByQuery($query, $n, $database = NULL, $numberPerPage = NULL)
    {
        return BookServices::getDefault()->getBooksByQuery($query, $n, $database, $numberPerPage);
    }

    public static function getBooks($n)
    {
        return BookServices::getDefault()->getBooks($n);
    }

    public static function getAllBooks()
    {
        return BookServices::getDefault()->getAllBooks();
    }

    public static function getBooksByStartingLetter($letter, $n, $database = NULL, $numberPerPage = NULL)
    {
        return BookServices::getDefault()->getBooksByStartingLetter($letter, $n, $database, $numberPerPage);
    }

    public static function getEntryArray ($query, $params, $n, $database = NULL, $numberPerPage = NULL)
    {
        return BookServices::getDefault()->getEntryArray($query, $params, $n, $database, $numberPerPage);
    }

    public static function getAllRecentBooks()
    {
        return BookServices::getDefault()->getAllRecentBooks();
    }
}
